			...
			<div class="row">
				<div class="col-md-12">
					<div class="thumbnail" style="    border-radius: 0px;">
						<img src="${ctp}/img/services-box1.jpg" class="img-thumbnail" alt="">
						<div class="caption" style="text-align:center;">
							<h3>
								${loginUser.loginacct }
							</h3>
							<span class="label label-danger" style="cursor:pointer;" onclick="window.location.href='${ctp}/member/auth.html'">未实名认证</span>
						</div>
					</div>
				</div>
			</div>
