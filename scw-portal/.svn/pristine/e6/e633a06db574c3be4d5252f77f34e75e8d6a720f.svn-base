...
<body> 
	...
	<div class="container">
		...
		<form id="regForm" class="form-signin" role="form"
			action="${ctp}/member/regist" method="post">
			<h2 class="form-signin-heading">
				<i class="glyphicon glyphicon-log-in"></i> 用户注册
				<span style="color: red;font-size: 14px;"><br/>${msg }</span>
			</h2>
			<div class="form-group has-success has-feedback">
				<input type="text" name="loginacct" class="form-control"
					id="loginacct_input" placeholder="请输入登录账号" value="${TMemeber.loginacct }" autofocus> 
				<span
			...
			<div class="form-group has-success has-feedback">
				<input type="text" class="form-control" name="email" value="${TMemeber.email }"
